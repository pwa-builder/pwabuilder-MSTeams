...
function Platform (packageName, platforms) {
  ...
  self.create = function (w3cManifestInfo, rootDir, options, href, callback) {
    ...
    try {
      ...
      w3cManifestInfo.packageName = msTeamsSchemaParams.name; // package name
      //w3cManifestInfo.description (not sure which one this maps to.)
      w3cManifestInfo.privacyUrl = msTeamsSchemaParams.privacyUrl;
      w3cManifestInfo.termsOfUseUrl = msTeamsSchemaParams.termsOfUseUrl;
    } (e) {}
